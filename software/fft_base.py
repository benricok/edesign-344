...
from matplotlib.widgets import Button, RadioButtons, Dropdown
...
ax_dropdown = plt.axes([0.05, 0.15, 0.25, 0.1])
dropdown = Dropdown(ax_dropdown, label="FFT Method", options=fft_options)
...
dropdown.on_select(select_fft_method)
